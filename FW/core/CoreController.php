...
abstract class CoreController {
    ...
    **/
    protected function setView() {
        try {
            ...
            $this->_view->role = ($this->_mod_auth!==null ? $this->_mod_auth->getRole(): null);
            $this->_view->id = ($this->_mod_auth!==null ? $this->_mod_auth->getId(): null);
            $this->_view->mdp = ($this->_mod_auth!==null ? $this->_mod_auth->getMdp(): null);
    ...
    **/
    protected function setModel() {
        ...
        if( file_exists( ( isset( $this->_settings['model']['path'] ) ? $this->_settings['model']['path'] : '' ) . $modelName . '.php' ) ) {
            ...
            throw new CoreException( 'Can not find the specified model' );
        }
    }
    ...
    **/
    public function preload() {
        $this->_mod_auth = new AuthentificationModule( ( defined( 'APP_TAG' ) ? APP_TAG : '' ) );
    }
    ...
    public function launcher( $action ) {
        try {
            if( method_exists( $this, $action ) ){
                ...
                throw new CoreException( 'Can not find the specified controller\'s method' );
            }
        } catch( Exception $e ) {
