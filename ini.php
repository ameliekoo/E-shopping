...
if( strtoupper( substr( PHP_OS, 0, 3 ) ) == 'WIN' ) { // If the version of the operating system (provided by the pre-defined constants PHP_OS) corresponds to a Windows kernel,
    ...
    if( !defined( 'LOCALE_STRING') ){ define( 'LOCALE_STRING', 'fra' ); }
else{
    if( !defined( 'PHP_EOL') ){ define( 'PHP_EOL', "\n" ); }
    if( !defined( 'DIRECTORY_SEPARATOR') ){ define( 'DIRECTORY_SEPARATOR', "/" ); }
    if( !defined( 'LOCALE_STRING') ){ define( 'LOCALE_STRING', 'fr-FR' ); }
	}
}
/**
 * --------------------------------------------------
...
if( !defined( 'DB_NAME' ) ) define( 'DB_NAME', 'shop' );
if( !defined( 'DB_LOGIN' ) ) define( 'DB_LOGIN', 'root' );
if( !defined( 'DB_PWD' ) ) define( 'DB_PWD', 'mimi701105' );
/**
 * --------------------------------------------------
 * CACHE
 * --------------------------------------------------
...
if( !defined( 'APP_TAG' ) ) define( 'APP_TAG', 'E-shopping );
